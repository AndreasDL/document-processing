...
<xsl:template name="writeBranch">
    ...
    <branch>
        ...
        <!--xsl:attribute name="last_word">
            <xsl:value-of select="$last_word"/>
        </xsl:attribute-->
